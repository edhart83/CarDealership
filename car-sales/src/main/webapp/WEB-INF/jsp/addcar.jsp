			...
			<div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
				...
				<main>
					...
					<div
						...
						<h1 class="text-2xl font-semibold">Add A Car</h1>
						...
						<div
							...
							<div class="card shadow-sm">
								...
								<div class="card-body">
									...
									<!-- -------------------- THIS IS THE START OF SPRING FORM -------------------- -->
            <h1>${msg}</h1>
            <form:form action="/addCar" modelAttribute="carToAdd" class="space-y-6" method="post" enctype="multipart/form-data">
              <form:input
              	path="year"
