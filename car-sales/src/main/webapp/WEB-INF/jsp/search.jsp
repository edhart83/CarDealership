...
<title>Search | Car Sales System</title>
<link
...
<body>
	<div x-data="setup()"
        ...
        <!-- ---------------------------------------- SIDEBAR WAS HERE -------------------------------------------- -->
		<jsp:include page="components/main-sidebar-nav.jsp" />
			...
			<div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
				...
				<header class="relative bg-white dark:bg-darker">
					<div
						...
						<button @click="isMobileMainMenuOpen = !isMobileMainMenuOpen"
							...
							<span class="sr-only">Open main manu</span> <span
								aria-hidden="true"> <svg class="w-8 h-8"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round"
						...
						<a href="index.html"
							...
							Eddie's Car Sales System v1.0 </a>

						<!-- Mobile sub menu button -->
						<button @click="isMobileSubMenuOpen = !isMobileSubMenuOpen"
							class="p-1 transition-colors duration-200 rounded-md text-primary-lighter bg-primary-50 hover:text-primary hover:bg-primary-100 dark:hover:text-light dark:hover:bg-primary-dark dark:bg-dark md:hidden focus:outline-none focus:ring">
							<span class="sr-only">Open sub manu</span> <span
								aria-hidden="true"> <svg class="w-8 h-8"
									xmlns="http://www.w3.org/2000/svg" fill="none"
									viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round"
							...
							<div class="relative" x-data="{ open: false }">
								<button
									...
									<span class="sr-only">User menu</span> <img
										class="w-10 h-10 rounded-full"
										src="resources/images/avatar.jpg" alt="Eddie R" />
								</button>
								...
								<div x-show="open" x-ref="userMenu"
									...
									<a href="#" role="menuitem"
										...
										Your Profile </a> <a href="#" role="menuitem"
										class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary">
										Settings </a> <a href="#" role="menuitem"
										class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary">
										Logout </a>
								</div>
							</div>
					...
					<!-- Mobile main manu -->
					<div class="border-b md:hidden dark:border-primary-darker"
						...
						<nav aria-label="Main" class="px-2 py-4 space-y-2">
							...
							<div x-data="{ isActive: true, open: true}">
								...
								<a href="#" @click="$event.preventDefault(); open = !open"
									...
									:aria-expanded="(open || isActive) ? 'true' : 'false'"> <span
                        ...
                        <path stroke-linecap="round"
								...
								</span> <span class="ml-2 text-sm"> Dashboards </span> <span
									class="ml-auto" aria-hidden="true"> <!-- active class 'rotate-180' -->
                        ...
                        <path stroke-linecap="round"
								...
								<div role="menu" x-show="open" class="mt-2 space-y-2 px-7"
									...
									<a href="index.html" role="menuitem"
										...
										Default </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Project Mangement (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										E-Commerce (soon) </a>
								</div>
							</div>
                        ...
                        <path stroke-linecap="round"
								...
								</span> <span class="ml-2 text-sm"> Components </span> <span
									aria-hidden="true" class="ml-auto"> <!-- active class 'rotate-180' -->
										<svg class="w-4 h-4 transition-transform transform"
											:class="{ 'rotate-180': open }"
											xmlns="http://www.w3.org/2000/svg" fill="none"
											viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round"
								...
								<div x-show="open" class="mt-2 space-y-2 px-7" role="menu"
									...
									<a href="#" role="menuitem"
										...
										Alerts (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
										Buttons (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Cards (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Dropdowns (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Forms (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Lists (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Modals (soon) </a>
								</div>
							</div>
                        ...
                        <path stroke-linecap="round"
								...
								</span> <span class="ml-2 text-sm"> Pages </span> <span
									aria-hidden="true" class="ml-auto"> <!-- active class 'rotate-180' -->
										<svg class="w-4 h-4 transition-transform transform"
											:class="{ 'rotate-180': open }"
											xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path stroke-linecap="round"
								...
								<div x-show="open" class="mt-2 space-y-2 px-7" role="menu"
									...
									<a href="pages/blank.html" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
										Blank </a> <a href="pages/404.html" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
										404 </a> <a href="pages/500.html" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
										500 </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
										Profile (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Pricing (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Kanban (soon) </a> <a href="#" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Feed (soon) </a>
								</div>
							</div>
                        ...
                        <path stroke-linecap="round"
								...
								</span> <span class="ml-2 text-sm"> Authentication </span> <span
									aria-hidden="true" class="ml-auto"> <!-- active class 'rotate-180' -->
										<svg class="w-4 h-4 transition-transform transform"
											:class="{ 'rotate-180': open }"
											xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path stroke-linecap="round"
								...
								<div x-show="open" class="mt-2 space-y-2 px-7" role="menu"
									...
									<a href="register" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Register </a> <a href="auth/login.html" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Login </a> <a href="auth/forgot-password.html" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Forgot Password </a> <a href="auth/reset-password.html"
										role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
										Reset Password </a>
								</div>
                        ...
                        <path stroke-linecap="round"
								...
								</span> <span class="ml-2 text-sm"> Layouts </span> <span
									aria-hidden="true" class="ml-auto"> <!-- active class 'rotate-180' -->
										<svg class="w-4 h-4 transition-transform transform"
											:class="{ 'rotate-180': open }"
											xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path stroke-linecap="round"
								...
								<div x-show="open" class="mt-2 space-y-2 px-7" role="menu"
									...
									<a href="layouts/two-columns-sidebar.html" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
										Two Columns Sidebar </a> <a
										href="layouts/mini-plus-one-columns-sidebar.html"
										role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
										Mini + One Columns Sidebar </a> <a
										href="layouts/mini-column-sidebar.html" role="menuitem"
										class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
				...
				<main>
					...
					<div
						...
						<a href="https://github.com/Kamona-WD/kwd-dashboard"
							target="_blank"
					        ...
					        <div class="col-md-10">
					            <div class="card p-3 py-4">
					                ...
					                <div class="row g-3 mt-2">
					                	<form id="searchform" action="searchnow" method="post" style="display:flex">
						                    <div class="col-md-3">
						                        <div class="dropdown"> <a class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false"> Any Status </a>
						                    ...
						                    <div class="col-md-6"> <input type="text" name="keyword" class="form-control" placeholder="Enter color, make, model, year, etc."> </div>
						                    <div class="col-md-3"> <a href="#" onclick="document.getElementById('searchform').submit()" class="btn btn-secondary btn-block">Search Results</a></div>
					                    </form>
					                </div>
					                <div class="mt-3"> <a data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" class="advanced"> Advance Search With Filters <i class="fa fa-angle-down"></i> </a>
					                    <div class="collapse" id="collapseExample">
					                        <div class="card card-body">
					                            <div class="row">
					                                <div class="col-md-4"> <input type="text" class="form-control" placeholder="Make"> </div>
					                                <div class="col-md-4"> <input type="text" class="form-control" placeholder="Model"> </div>
					                                <div class="col-md-4"> <input type="text" class="form-control" placeholder="Year"> </div>
					                            </div>
					                        </div>
					                    </div>
					                </div>
...
<!-- -------------------- TEST TO SEE IF SEARCH BOX WORKS -------------------- -->
<table class="table table-hover">
		...
		<tbody>
				...
				<tr style="display: table-row;">
					...
					<td>232</td>
					<td>ed@test.com
					<a href="delete-ed@test.com" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a></td>
					<td>433434</td>
					<td><a href="editUser?email=ed@test.com" class="text-info"><i class="fa fa-edit"></i></a>  
					<a href="deleteById-107" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a>
				...
				<tr style="display: table-row;">
					...
					<td>23</td>
					<td>Freddy@test.com
					<a href="delete-Freddy@test.com" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a></td>
					<td>5454</td>
					<td><a href="editUser?email=Freddy@test.com" class="text-info"><i class="fa fa-edit"></i></a>  
					<a href="deleteById-108" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a>
				...
				<tr style="display: table-row;">
					...
					<td>42</td>
					<td>Teddy@test.com
					<a href="delete-Teddy@test.com" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a></td>
					<td>454543</td>
					<td><a href="editUser?email=Teddy@test.com" class="text-info"><i class="fa fa-edit"></i></a>  
					<a href="deleteById-139" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a>
				...
				<tr style="display: table-row;">
					...
					<td>32</td>
					<td>betty@test.com
					<a href="delete-betty@test.com" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a></td>
					<td>565545980</td>
					<td><a href="editUser?email=betty@test.com" class="text-info"><i class="fa fa-edit"></i></a>  
					<a href="deleteById-140" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a>
				...
				<tr style="display: table-row;">
					...
					<td>54</td>
					<td>red@test.com
					<a href="delete-red@test.com" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a></td>
					<td>65645</td>
					<td><a href="editUser?email=red@test.com" class="text-info"><i class="fa fa-edit"></i></a>  
					<a href="deleteById-141" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a>
				...
				<tr style="display: table-row;">
					...
					<td>3434</td>
					<td><a href="editUser?email=ed@test.com" class="text-info"><i class="fa fa-edit"></i></a>  
					<a href="deleteById-171" onclick="confirmed(); return false;" class="text-danger"><i class="fa fa-trash"></i></a>
								...
								<c:forEach var="car" items="${carList}">
									<div
										...
										<div class="card shadow-sm">
											<img class="card-image eCustomCover" width="277.75px" height="225px" alt=""
												src="resources/images/${ car.imagePath }">
											<div class="card-body">
												...
												<div
													...
													<div class="btn-group">
														<a href="/details?id=${ car.id }" type="button"
...
<%-- 														</c:if> --%>
				...
				<!-- Main footer -->
				<footer
					class="flex items-center justify-between p-4 bg-white border-t dark:bg-darker dark:border-primary-darker custom-sticky-footer">
					<div>K-WD &copy; 2021</div>
					<div>
						Made by <a href="https://github.com/Kamona-WD" target="_blank"
							class="text-blue-500 hover:underline">Ahmed. </a> Customized by
						Eddie.
					</div>
				</footer>
			</div>
						...
						<div class="space-y-4"
                          ...
                          <path stroke-linecap="round"
									...
									<div class="flex-1 overflow-hidden">
										...
										<p
											...
											Looks like there might be a new theme soon</p>
										<span
                          ...
                          <path stroke-linecap="round"
									...
									<div class="flex-1 overflow-hidden">
										...
										<p
											class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
											Successful new version was released</p>
										<span
											class="text-sm font-normal text-gray-400 dark:text-primary-light">
											2d ago </span>
									</div>
						...
						<div class="space-y-4" x-show.transition.in="activeTabe == 'user'">
							<a href="#" class="block">
								<div class="flex px-4 space-x-4">
									...
									<div class="flex-1 overflow-hidden">
										<h5
											class="text-sm font-semibold text-gray-600 dark:text-light">Eddie
											R</h5>
										<p
											class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
											Shared new project "Eddie's Car Sales System v.10"</p>
										<span
											class="text-sm font-normal text-gray-400 dark:text-primary-light">
											1d ago </span>
									</div>
								...
								<div class="flex px-4 space-x-4">
									<div class="relative flex-shrink-0">
										<span
											class="relative z-10 inline-block overflow-visible rounded-ful">
											<img class="object-cover rounded-full w-9 h-9"
											src="resources/images/avatar-1.jpg" alt="Eddie R" />
										</span>
										<div
											class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
									</div>
									<div class="flex-1 overflow-hidden">
										<h5
											class="text-sm font-semibold text-gray-600 dark:text-light">John</h5>
										<p
											class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
											Commit new changes to Eddie's Car Sales System v.10 project.
										</p>
										<span
											class="text-sm font-normal text-gray-400 dark:text-primary-light">
											10h ago </span>
								...
								<div class="flex px-4 space-x-4">
									...
									<div class="flex-1 overflow-hidden">
										...
										<p
											class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
											Release new version "Eddie's Car Sales System v.10"</p>
										<span
											class="text-sm font-normal text-gray-400 dark:text-primary-light">
											20d ago </span>
									</div>
			...
			<section
				...
				<div class="flex flex-col h-screen">
                  ...
                  <path stroke-linecap="round" stroke-linejoin="round"
						...
						</span> <input x-ref="searchInput" type="text"
					...
					<div
						...
						<h3
							class="py-2 text-sm font-semibold text-gray-600 dark:text-light">History</h3>
						<a href="#" class="flex space-x-4">
							<div class="flex-shrink-0">
								<img class="w-10 h-10 rounded-lg"
									src="resources/images/cover.jpg" alt="Post cover" />
							</div>
						...
						</a> <a href="#" class="flex space-x-4">
							<div class="flex-shrink-0">
								<img class="w-10 h-10 rounded-lg"
									src="resources/images/avatar.jpg" alt="Eddie R" />
							</div>
							<div class="flex-1 max-w-xs overflow-hidden">
								<h4 class="text-sm font-semibold text-gray-600 dark:text-light">Eddie
									R</h4>
								<p
									class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
									Last activity 3h ago.</p>
								<span
									class="text-sm font-normal text-gray-400 dark:text-primary-light">
									Offline </span>
							</div>
							...
							<div class="flex-shrink-0">
								<img class="w-10 h-10 rounded-lg"
									src="resources/images/cover-2.jpg"
									alt="Eddie's Car Sales System v.10" />
							</div>
							<div class="flex-1 max-w-xs overflow-hidden">
								<h4 class="text-sm font-semibold text-gray-600 dark:text-light">Eddie's
									Car Sales System v.10</h4>
								<p
									class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
						...
						<template x-for="i in 10" x-key="i">
							<a href="#" class="flex space-x-4">
								<div class="flex-shrink-0">
									<img class="w-10 h-10 rounded-lg"
										src="resources/images/cover-3.jpg"
										alt="Eddie's Car Sales System v.10" />
								</div>
								<div class="flex-1 max-w-xs overflow-hidden">
									<h4 class="text-sm font-semibold text-gray-600 dark:text-light">Eddie's
	...
	<script>
      const setup = () => {
        ...
        const setColors = (color) => {
          ...
          root.style.setProperty('--color-primary', `var(--color-)`)
          root.style.setProperty('--color-primary-50', `var(--color--50)`)
          root.style.setProperty('--color-primary-100', `var(--color--100)`)
          root.style.setProperty('--color-primary-light', `var(--color--light)`)
          root.style.setProperty('--color-primary-lighter', `var(--color--lighter)`)
          root.style.setProperty('--color-primary-dark', `var(--color--dark)`)
          root.style.setProperty('--color-primary-darker', `var(--color--darker)`)
