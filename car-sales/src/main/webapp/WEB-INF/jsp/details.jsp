...
<title>Details | Car Sales System</title>
<link
...
<!-- ----------- This made buttons on inventory page work again. I think my customizations effected other buttons. -->
...
<!-- 									Value</h6> -->
<!-- 								<span class="text-xl font-semibold">$30,000</span> <span -->
...
<!-- 									class="text-xs font-medium leading-none tracking-wider text-gray-500 uppercase dark:text-primary-light"> -->
<!-- 									Users</h6> -->
<!-- 								<span class="text-xl font-semibold">50,021</span> <span -->
<!-- 									class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md"> -->
<!-- 									+2.6% </span> -->
<!-- 							</div> -->
<!-- 							<div> -->
...
<!-- 									class="text-xs font-medium leading-none tracking-wider text-gray-500 uppercase dark:text-primary-light"> -->
<!-- 									Orders</h6> -->
<!-- 								<span class="text-xl font-semibold">45,021</span> <span -->
<!-- 									class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md"> -->
<!-- 									+3.1% </span> -->
<!-- 							</div> -->
<!-- 							<div> -->
...
<!-- 									class="text-xs font-medium leading-none tracking-wider text-gray-500 uppercase dark:text-primary-light"> -->
<!-- 									Tickets</h6> -->
<!-- 								<span class="text-xl font-semibold">20,516</span> <span -->
<!-- 									class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md"> -->
<!-- 									+3.1% </span> -->
<!-- 							</div> -->
<!-- 							<div> -->
...
<!-- 					</div> -->
					...
					<!-- ------------------------ START OF CARD BLOCK ---------------------------- -->
					<div
						class="grid grid-cols-1 gap-8 p-4">
						<div
							class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker eCustomDetails">
							<div class="card shadow-sm">
								<img class="card-image eCustomCoverDetails" width="277.75px"
									height="225px" alt="" src="resources/images/${ car.imagePath }">
								<div class="card-body">
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="btn-group">
											<a href="inventory" type="button"
												class="btn btn-primary">Return</a>
											<c:if test="${car.specialPricing == false}">
											...
											<c:if test="${car.specialPricing == true}">
												<p class="bidText">This vehicle is on Special!</p>
