              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="resources/images/avatar.jpg" alt="Eddie R" />
                  </button>
                  ...
                  <div class="card shadow-sm">
			            ...
			            <div class="card-body">
			              ...
			              <div class="d-flex justify-content-between align-items-center">
			                <div class="btn-group">
			                  <button type="button" class="btn btn-sm btn-outline-secondary eCustomButton">View</button>
			                  <button type="button" class="btn btn-sm btn-outline-secondary eCustomButton">Edit</button>
			                </div>
              ...
              <div class="space-y-4" x-show.transition.in="activeTabe == 'user'">
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Eddie R</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                        Shared new project "Eddie's Car Sales System v.10"
                      </p>
                  ...
                  <div class="flex px-4 space-x-4">
                    <div class="relative flex-shrink-0">
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        <img
                          class="object-cover rounded-full w-9 h-9"
                          src="resources/images/avatar-1.jpg"
                          alt="Eddie R"
                        />
                      </span>
                      <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
                ...
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Eddie R</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                        Release new version "Eddie's Car Sales System v.10"
                      </p>
          ...
          <div class="flex flex-col h-screen">
            ...
            <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="resources/images/cover.jpg" alt="Post cover" />
                </div>
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="resources/images/avatar.jpg" alt="Eddie R" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
                  <h4 class="text-sm font-semibold text-gray-600 dark:text-light">Eddie R</h4>
                  <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="resources/images/cover-2.jpg" alt="Eddie's Car Sales System v.10" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
                  <h4 class="text-sm font-semibold text-gray-600 dark:text-light">Eddie's Car Sales System v.10</h4>
                  <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
              ...
              <template x-for="i in 10" x-key="i">
                <a href="#" class="flex space-x-4">
                  <div class="flex-shrink-0">
                    <img class="w-10 h-10 rounded-lg" src="resources/images/cover-3.jpg" alt="Eddie's Car Sales System v.10" />
                  </div>
                  <div class="flex-1 max-w-xs overflow-hidden">
                    <h4 class="text-sm font-semibold text-gray-600 dark:text-light">Eddie's Car Sales System v.10</h4>
                    <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
